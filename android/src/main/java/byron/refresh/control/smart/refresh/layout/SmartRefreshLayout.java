package byron.refresh.control.smart.refresh.layout;
...
import byron.refresh.control.smart.refresh.layout.constant.DimensionStatus;
...
import byron.refresh.control.smart.refresh.layout.listener.DefaultRefreshFooterCreator;
import byron.refresh.control.smart.refresh.layout.listener.DefaultRefreshHeaderCreator;
import byron.refresh.control.smart.refresh.layout.listener.DefaultRefreshInitializer;
import byron.refresh.control.smart.refresh.layout.listener.OnLoadMoreListener;
import byron.refresh.control.smart.refresh.layout.listener.OnMultiListener;
import byron.refresh.control.smart.refresh.layout.listener.OnRefreshListener;
import byron.refresh.control.smart.refresh.layout.listener.OnRefreshLoadMoreListener;
import byron.refresh.control.smart.refresh.layout.listener.OnStateChangedListener;
import byron.refresh.control.smart.refresh.layout.listener.ScrollBoundaryDecider;
import byron.refresh.control.smart.refresh.layout.simple.SimpleBoundaryDecider;
import byron.refresh.control.smart.refresh.layout.util.SmartUtil;
import byron.refresh.control.smart.refresh.layout.wrapper.RefreshContentWrapper;
import byron.refresh.control.smart.refresh.layout.wrapper.RefreshFooterWrapper;
import byron.refresh.control.smart.refresh.layout.wrapper.RefreshHeaderWrapper;
...
import static byron.refresh.control.smart.refresh.layout.util.SmartUtil.dp2px;
import static byron.refresh.control.smart.refresh.layout.util.SmartUtil.fling;
import static byron.refresh.control.smart.refresh.layout.util.SmartUtil.isContentView;
...
//            reboundAnimator.setDuration(20000);
    ...
    protected void moveSpinnerInfinitely(float spinner) {
         ...
         *
         * 2.XML关闭
         *          <byron.refresh.control.smart.refresh.layout.SmartRefreshLayout
